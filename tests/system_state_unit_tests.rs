...
mod tests {
    ...
    pub fn run_system_state_tests() -> ass_easy_loop::test_framework::TestSuiteResult {
        let tests = [
            (
                "test_battery_state_basic",
                test_battery_state_basic as fn() -> TestResult,
            ),
            (
                "test_log_config_basic",
                test_log_config_basic as fn() -> TestResult,
            ),
            (
                "test_battery_state_from_adc",
                test_battery_state_from_adc as fn() -> TestResult,
            ),
            (
                "test_battery_state_thresholds",
                test_battery_state_thresholds as fn() -> TestResult,
            ),
            (
                "test_battery_state_transitions",
                test_battery_state_transitions as fn() -> TestResult,
            ),
            (
                "test_log_config_serialization",
                test_log_config_serialization as fn() -> TestResult,
            ),
            (
                "test_log_config_validation",
                test_log_config_validation as fn() -> TestResult,
            ),
            (
                "test_data_structure_sizes",
                test_data_structure_sizes as fn() -> TestResult,
            ),
            (
                "test_basic_functionality",
                test_basic_functionality as fn() -> TestResult,
            ),
        ];
    ...
    // Entry point removed - this is a regular test file
} // Close tests module
