...
mod tests {
    ...
    fn test_stress_test_parameter_serialization() {
        ...
        assert_eq!(parsed_params.memory_stress_enabled, params.memory_stress_enabled);
        ...
        assert_eq!(parsed_params.concurrent_operations, params.concurrent_operations);
        assert_eq!(parsed_params.stress_pattern, params.stress_pattern);
        assert_eq!(parsed_params.performance_threshold_percent, params.performance_threshold_percent);
    }
    ...
    fn test_stress_test_statistics() {
        ...
        assert!((success_rate - 92.59).abs() < 0.1); // ~92.59% success rate (150/162)
