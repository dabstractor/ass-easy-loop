...
mod timing_tests {
    ...
    fn test_timing_accuracy_tolerance() {
        ...
        assert!(
            ...
            "HIGH pulse timing within ±1% tolerance"
        );
        assert!(
            low_min <= 498.0 && 498.0 <= low_max,
            "LOW pulse timing within ±1% tolerance"
        );
    ...
    fn test_gpio_control_timing() {
        ...
        assert!(
            ...
            "HIGH pulse should have sufficient time after GPIO overhead"
        );
        assert!(
            effective_low_time > 497.9,
            "LOW pulse should have sufficient time after GPIO overhead"
        );
    }
    ...
    fn test_timing_precision_requirements() {
        ...
        let high_max_deviation =
            (PULSE_HIGH_DURATION_MS as f32 * REQUIRED_PRECISION_PERCENT / 100.0);
        ...
        assert!(
            ...
            "HIGH pulse precision tolerance should be at least 0.02ms"
        );
        assert!(
            low_max_deviation >= 4.98,
            "LOW pulse precision tolerance should be at least 4.98ms"
        );
        ...
        assert!(
            ...
            "Total period precision tolerance should be at least 5ms"
        );
    }
}
