...
use crate::logging::{log_message, LogLevel, LogMessage, LogQueue};
use core::fmt::Write;
use core::ops::FnOnce;
...
impl ResourceValidator {
    ...
    pub fn validate_hardware_resource_ownership() -> bool {
        ...
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Hardware resource validation: All resources managed by RTIC",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- MOSFET pin: Moved to Local struct (exclusive access)",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- LED pin: Moved to Shared struct (controlled access)",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- ADC peripheral: Moved to Local struct (exclusive access)",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- ADC pin: Moved to Local struct (exclusive access)",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- USB device: Moved to Shared struct (controlled access)",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- HID class: Moved to Shared struct (controlled access)",
        );
    ...
    pub fn validate_global_state_management() -> ValidationResult {
        ...
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Global state validation: Checking RTIC compliance",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Acceptable global state (justified):",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- GLOBAL_LOG_QUEUE: Panic handler and logging system",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- TIMESTAMP_FUNCTION: Panic handler timing",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- GLOBAL_LOG_CONFIG: Runtime configuration",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- GLOBAL_PERFORMANCE_STATS: System monitoring",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- USB_BUS: USB library requirement",
        );
    ...
    pub fn validate_resource_sharing_patterns() -> bool {
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Resource sharing validation: Checking RTIC patterns",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Shared resources (multi-task access):",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- led: Controlled by RTIC lock mechanism",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- adc_reading: Controlled by RTIC lock mechanism",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- battery_state: Controlled by RTIC lock mechanism",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- usb_dev: Controlled by RTIC lock mechanism",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- hid_class: Controlled by RTIC lock mechanism",
        );

        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Local resources (single-task access):",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- mosfet_pin: Exclusive access by pemf_pulse_task",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- adc: Exclusive access by battery_monitor_task",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- adc_pin: Exclusive access by battery_monitor_task",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- pulse_active: Exclusive access by pemf_pulse_task",
        );

        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Resource sharing patterns: VALIDATED",
        );
        true
    }
    ...
    pub fn validate_memory_safety() -> bool {
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "Memory safety validation: Checking patterns",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
        ...
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- No dynamic allocation (heap-free operation)",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
        ...
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- RTIC ownership prevents data races",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- Bounded collections (heapless::Vec, LogQueue)",
        );
        log_message(
            LogLevel::Info,
            "RESOURCE_VALIDATOR",
            "- No raw pointer dereferencing outside unsafe blocks",
        );
...
impl SafeLoggingAccess {
    ...
    pub fn safe_enqueue_log(message: LogMessage) -> Result<(), &'static str> {
        ...
        log_message(
            message.level,
            "SAFE_LOGGING",
            "Message enqueued via safe interface",
        );
        Ok(())
    }
}
...
impl ResourceLeakDetector {
    ...
    pub fn check_for_leaks() -> LeakDetectionResult {
        ...
        log_message(
            ...
            "Resource leak detection: Checking system resources",
        );
...
mod tests {
    ...
    fn test_leak_detection_result() {
        ...
        assert!(matches!(
            potential_leaks,
            LeakDetectionResult::PotentialLeaks(_)
        ));
    }
}
